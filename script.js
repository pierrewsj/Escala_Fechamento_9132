...
async function preencherDadosCargaPorColaborador(resetarSetorManual = false) {
  ...
  if ($('cargaSetor').dataset.manual !== 'true') { $('cargaSetor').value = setorAuto; $('cargaSetorInfo').textContent = setorAuto; }
...
async function iniciar() {
  if ($('versaoApp')) $('versaoApp').textContent = `Versão ${APP.versao || '2.1.0'}`;
