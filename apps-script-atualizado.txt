...
function obterEscalaSabadoPublica_(dataISO, turno, incluirRascunho) {
  ...
  for (let i = 0; i < valores.length; i += 1) {
    ...
    // Usa o valor real e, como segunda opção, o valor exibido. Isso funciona
    // tanto quando "Data ISO" é texto quanto quando o Google Sheets a converte em Date.
    ...
    if (!incluirRascunho && statusLinha !== 'PUBLICADA') continue;
