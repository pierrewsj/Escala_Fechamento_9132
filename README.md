...
## Versão 2.4.8
- Corrige a leitura compartilhada da escala de sábado em outros aparelhos.
- A leitura pública busca todos os registros da data e filtra o turno no aplicativo.
- Apps Script lê Data ISO tanto como data real quanto como texto.
- Service worker usa rede primeiro para reduzir versões antigas presas no cache.
- Esta versão exige atualizar e reimplantar o Apps Script.
